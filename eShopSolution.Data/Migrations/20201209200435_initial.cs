    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "75541226-1c56-4ef7-8b8c-99b694be622d", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUser",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "732ee8a5-942d-4e40-b7d6-70825af5322d", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "nguyenminhducit285@gmail.com", true, "Duc", "Nguyen Minh", false, null, "nguyenminhducit285@gmail.com", "admin", "AQAAAAEAACcQAAAAEL/vaQFx55UphOZtqQGGd+Ok21q0FYI5NJOIqeZpfaWLCtX81VSBoxuZqWNs9YHDDQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 12, 10, 3, 4, 35, 75, DateTimeKind.Local).AddTicks(5219), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "vi", "Ao Khoac Nu", "Ao Cho Nu", "San pham ao thoi trang nu", "Ao Khoac" },
                    { 3, 1, "vi", "Ao Khoac Nam", "Ao Cho Nam", "San pham ao thoi trang nam", "Ao Khoac" },
                    { 2, 2, "en", "Woman Jacket", "Jaket for Female", "The Fashion Product for Female", "Jacket" },
                    { 4, 1, "en", "Men Jacket", "Jaket for Male", "The Fashion Product for Male", "Jacket" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "Mo ta san pham", "vi", "Ao Khoac Nam", 1, "Ao Cho Nam", "San pham ao thoi trang nam", "Ao Khoac" },
                    { 2, "", "Description of product", "en", "Men Jacket", 1, "Jaket for Male", "The Fashion Product for Male", "Jacket" }
                });
